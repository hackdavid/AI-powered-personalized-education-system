...
from apps.school_admin.views import class_views, subject_views, teacher_views, student_views, document_views
...
urlpatterns = [
    ...
    path('classes/<int:pk>/subjects/', class_views.class_detail, name='class_detail'),
    ...
    # Documents / Books
    path('books/', document_views.document_list, name='document_list'),
    path('books/upload/', document_views.document_upload, name='document_upload'),
    path('books/<int:pk>/delete/', document_views.document_delete, name='document_delete'),
]
