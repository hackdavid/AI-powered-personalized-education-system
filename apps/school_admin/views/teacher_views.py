...
from apps.school_admin.forms import TeacherInviteForm
...
def teacher_list(request):
    teachers = User.objects.filter(
        tenant=request.tenant, role__name='teacher'
    ).select_related('role')
...
def teacher_invite(request):
    ...
    teachers = User.objects.filter(tenant=request.tenant, role__name='teacher').select_related('role')
    return render(request, 'school_admin/teachers/list.html', {
...
def teacher_edit(request, pk):
    ...
    return render(request, 'school_admin/teachers/list.html', {
        'teachers': User.objects.filter(tenant=request.tenant, role__name='teacher'),
